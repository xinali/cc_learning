...
#include "cc_chromium/mojo_test/mojom/test.mojom.h"
#include "cc_chromium/mojo_test/mojom/test2.mojom.h"
#include "cc_chromium/mojo_test/mojom/test3.mojom.h"
#include "cc_chromium/mojo_test/mojom/test4.mojom.h"
...
namespace mojo_test {
namespace multiple_process_bindings {

using namespace cc_chromium::mojo_test::mojom;

// #pragma region Test
class TestImpl : public cc_chromium::mojo_test::mojom::Test {
 public:
...
// #pragma region Test2
class Test2Impl : public cc_chromium::mojo_test::mojom::Test2 {
 public:
  explicit Test2Impl(mojo::PendingReceiver<cc_chromium::mojo_test::mojom::Test2> receiver)
 ...
 private:
  mojo::Receiver<cc_chromium::mojo_test::mojom::Test2> receiver_;
};

class ApiImpl : public cc_chromium::mojo_test::mojom::Api {
 public:
...
class Api2Impl : public cc_chromium::mojo_test::mojom::Api2 {
 public:
...
// #pragma region Test3
class Test3Impl : public cc_chromium::mojo_test::mojom::Test3 {
 public:
...
class Test32Impl : public cc_chromium::mojo_test::mojom::Test32 {
 public:
...
void MojoProducer() {
  ...
  // C++ binding API test
  {
    ...
    // using TestPtr = mojo::InterfacePtr<cc_chromium::mojo_test::mojom::Test>;
    // using TestPtrInfo = mojo::InterfacePtrInfo<cc_chromium::mojo_test::mojom::Test>;
...
void MojoConsumer() {
  ...
  // C++ binding API test
  {
    ...
    std::ignore = new mojo::Receiver<cc_chromium::mojo_test::mojom::Test>(
        test,
        mojo::PendingReceiver<cc_chromium::mojo_test::mojom::Test>(std::move(pipe)));
  }
  {
    // 演示将Receiver放到实现类中
...
TEST(CCChromiumTest, TestMojoMultipleProcessBindings) {
